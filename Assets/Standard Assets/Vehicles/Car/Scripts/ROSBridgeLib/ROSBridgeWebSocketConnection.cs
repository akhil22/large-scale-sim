 ...
 */
 ...
 namespace ROSBridgeLib {
 	public class ROSBridgeWebSocketConnection {
		...
		private List<Pair<Type,String >> _publishersNew;
		 ...
		 */
		 public ROSBridgeWebSocketConnection(string host, int port) {
		 	...
		 	_publishersNew = new List<Pair<Type, String>> ();
		 }
		 ...
		 */
		 ...
		 public void AddPublisherNew(Type msg, string topic){
		   IsValidPublisher(msg);
		   Pair<Type, String> pub = new Pair<Type, String> (msg, topic);
		   _publishersNew.Add (pub);
		//   Debug.Log ("Sending " + ROSBridgeMsg.Advertise (topic, GetMessageType(msg)));
		 }
		 private void Run() {
